    ...
    stages {
        ...
        stage('Build Stage') {
            steps {
                ...
                bat '"C:\\Program Files (x86)\\Microsoft Visual Studio\\2017\\BuildTools\\MSBuild\\15.0\\Bin\\MSBuild.exe" "%WORKSPACE%\\HelloWorld.sln" /t:"Clean" /p:Configuration=Release /p:Platform="x64"'
